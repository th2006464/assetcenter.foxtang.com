...
- **KPI**：设备总数、24h 内上报、VPN 已接入、Windows 11、客户端待升级、30 天未上报。
- **分布图**：操作系统版本、设备活跃度（按最后上报时间分 24h / 1-3 天 / 4-7 天 / 8-30 天 / 30 天以上）、VPN 接入状态、厂商、设备形态（按型号关键词识别笔记本 / 台式机）、Outlook 账号绑定、客户端版本、机型 Top 10。
